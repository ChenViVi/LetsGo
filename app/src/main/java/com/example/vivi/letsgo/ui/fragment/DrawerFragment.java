...
import com.example.vivi.letsgo.adapter.NavigationDrawerAdapter;
import com.example.vivi.letsgo.model.NavDrawerItem;
import com.example.vivi.letsgo.ui.LoginActivity;
import com.example.vivi.letsgo.ui.UserInfoActivity;
...
public class DrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userHeadImage = (NetworkImageView) layout.findViewById(R.id.nimg_user_image);
        ...
        userNickName = (TextView) layout.findViewById(R.id.tv_user_nick_name);
        userNickName.setText(pref.getString("nickname","请登录 "));

        userHeadLayout = (RelativeLayout) layout.findViewById(R.id.layout_user_header);
