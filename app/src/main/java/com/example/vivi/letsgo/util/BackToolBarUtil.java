package com.example.vivi.letsgo.util;
...
public class BackToolBarUtil {
    ...
    * */
    ...
    public BackToolBarUtil(Context context, int layoutId) {
    ...
    private void initToolBar() {
        ...
        View toolbar = mInflater.inflate(R.layout.activity_back_toolbar, mContentView);
