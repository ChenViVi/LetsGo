 ...
 */
public class ListHotGroupFragment extends ListFragment {
    @Override
    public StringRequest getHotGroupRequest(final String page,final boolean needRefresh) {
            StringRequest hotGroupRequest = new StringRequest(Request.Method.POST,"http://letsgo966.vipsinaapp.com/index.php/ios/client/getheatgroup",
